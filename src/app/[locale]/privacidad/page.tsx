...
export default async function PrivacyPage({
  ...
  return (
    <article className="container-rc py-20 sm:py-28 lg:py-32">
      <div className="max-w-2xl lg:max-w-3xl">
        <h1 className="font-[var(--font-display)] text-3xl lg:text-4xl font-bold text-[var(--color-ink)] mb-3">
          {t("title")}
        </h1>
        <p className="text-xs text-[var(--color-ink-muted)] mb-10">{t("lastUpdate")}</p>

        <div className="space-y-6 text-sm lg:text-base text-[var(--color-ink)] leading-relaxed">
        <p>
